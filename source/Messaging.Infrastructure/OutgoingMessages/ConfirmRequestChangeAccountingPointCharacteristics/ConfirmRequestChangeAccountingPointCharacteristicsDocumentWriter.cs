    ...
    public ConfirmRequestChangeAccountingPointCharacteristicsDocumentWriter(IMarketActivityRecordParser parser)
        : base(
            new DocumentDetails(
                ...
                "urn:ediel.org:structure:confirmrequestchangeaccountingpointcharacteristics:0:1 urn-ediel-org-structure-confirmrequestchangeaccountingpointcharacteristics-0-1.xsd",
                "urn:ediel.org:structure:confirmrequestchangeaccountingpointcharacteristics:0:1",
                "cim",
                "E59"),
            parser,
            "A01")
