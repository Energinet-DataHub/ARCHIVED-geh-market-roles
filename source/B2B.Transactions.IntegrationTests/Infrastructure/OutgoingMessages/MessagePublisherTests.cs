...
namespace B2B.Transactions.IntegrationTests.Infrastructure.OutgoingMessages
{
    ...
    public class MessagePublisherTests : TestBase
    {
        ...
        private OutgoingMessage CreateOutgoingMessage()
        {
            ...
            return new OutgoingMessage(document.DocumentType, document.MessagePayload, transaction.Message.ReceiverId, _correlationContext.Id, transaction.MarketActivityRecord.Id, transaction.MarketActivityRecord.MarketEvaluationPointId);
        }
    }
}
