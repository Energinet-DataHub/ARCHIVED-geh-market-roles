...
{
    public class ProcessInternalCommandsEveryTenSeconds : INotificationHandler<TenSecondsHasPassed>
    {
        private readonly InternalCommandProcessor _internalCommandProcessor;

        public ProcessInternalCommandsEveryTenSeconds(InternalCommandProcessor internalCommandProcessor)
        {
