...
{
    public class ForwardMeteringPointDetailsInbound : ProtobufInboundMapper<ForwardMeteringPointDetails>
    {
        protected override IInboundMessage Convert(ForwardMeteringPointDetails obj)
        {
