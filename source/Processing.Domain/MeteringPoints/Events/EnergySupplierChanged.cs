...
{
    public class EnergySupplierChanged : DomainEvent
    {
        public EnergySupplierChanged(Guid accountingPointId, string gsrnNumber, Guid businessProcessId, Guid energySupplierId, Instant startOfSupplyDate)
        {
