...
namespace Processing.Domain.MeteringPoints.Rules.ChangeEnergySupplier
{
    public class ProductionMeteringPointMustBeObligatedRule : IBusinessRule
    {
        ...
        internal ProductionMeteringPointMustBeObligatedRule(MeteringPointType meteringPointType, in bool isProductionObligated)
        {
        ...
        public ValidationError ValidationError => new ProductionMeteringPointMustBeObligatedRuleError();
    }
}
