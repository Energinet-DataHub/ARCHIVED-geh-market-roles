...
{
    public class MoveOutRegisteredOnSameDateIsNotAllowedRuleError : ValidationError
    {
        public MoveOutRegisteredOnSameDateIsNotAllowedRuleError(Instant moveOutDate)
        {
