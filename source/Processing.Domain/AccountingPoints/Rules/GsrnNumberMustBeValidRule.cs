...
namespace Processing.Domain.AccountingPoints.Rules
{
    internal class GsrnNumberMustBeValidRule : IBusinessRule
    {
        private const int RequiredIdLength = 18;
        private readonly string _gsrnValue;

        public GsrnNumberMustBeValidRule(string gsrnValue)
        {
