...
namespace B2B.Transactions.Transactions
{
    public class RegisterTransaction
    {
        ...
        public Task HandleAsync(B2BTransaction transaction)
        {
            ...
            var outgoingMessage = new OutgoingMessage(document.DocumentType, document.MessagePayload, transaction.Message.ReceiverId, _correlationContext.Id, transaction.MarketActivityRecord.Id, transaction.MarketActivityRecord.MarketEvaluationPointId);
