...
namespace Processing.Application.ChangeOfSupplier
{
    public class RequestChangeOfSupplierHandler : IBusinessRequestHandler<RequestChangeOfSupplier>
    {
        ...
        private global::Processing.Domain.AccountingPoints.AccountingPoint? _accountingPoint;
        ...
        private Task<global::Processing.Domain.AccountingPoints.AccountingPoint?> GetMeteringPointAsync(string gsrnNumber)
        {
