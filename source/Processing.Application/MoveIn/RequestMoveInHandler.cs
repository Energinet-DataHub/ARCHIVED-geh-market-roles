...
namespace Processing.Application.MoveIn
{
    public class RequestMoveInHandler : IBusinessRequestHandler<RequestMoveIn>
    {
        ...
        private static BusinessProcessResult Validate(EnergySupplier energySupplier, global::Processing.Domain.AccountingPoints.AccountingPoint accountingPoint, RequestMoveIn request)
        {
        ...
        private static BusinessProcessResult CheckBusinessRules(global::Processing.Domain.AccountingPoints.AccountingPoint accountingPoint, RequestMoveIn request)
        {
