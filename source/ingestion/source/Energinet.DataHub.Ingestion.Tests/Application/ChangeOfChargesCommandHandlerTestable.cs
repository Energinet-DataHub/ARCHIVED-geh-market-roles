...
namespace Energinet.DataHub.Ingestion.Tests.Application
{
    ...
    {
        public ChangeOfChargesCommandHandlerTestable(ILogger<ChangeOfChargesCommandHandler> logger, IValidationReportQueueDispatcher validationReportQueueDispatcher, IChargeRepository chargeRepository, IIso8601Durations iso8601Durations)
            : base(logger, validationReportQueueDispatcher, chargeRepository, iso8601Durations)
        {
        }
