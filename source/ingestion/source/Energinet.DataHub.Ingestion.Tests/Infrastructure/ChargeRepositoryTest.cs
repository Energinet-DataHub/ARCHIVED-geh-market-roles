...
using NodaTime;
using Xunit;
using ChargeType = Energinet.DataHub.Ingestion.Infrastructure.ChangeOfCharges.Context.ChargeType;
...
#pragma warning restore CS8602 // Dereference of a possibly null reference.
        ...
        private static ChangeOfChargesMessage GetValidChangeOfChargesMessage()
        {
            var message = new ChangeOfChargesMessage
            {
                ...
                {
                    ChargeType = new Ingestion.Application.ChangeOfCharges.ChargeType
        ...
        private void SeedDatabaseContext()
        {
            ...
            var chargeOwners = new List<MarketParticipant> { new MarketParticipant { MRid = KnownChargeOwner, Id = 1, } };
