...
namespace Energinet.DataHub.Ingestion.Application.ChangeOfCharges
{
    ...
    {
        /// <summary>
        /// Stores the given <see cref="ChangeOfChargesMessage"/> in persistent storage.
        /// </summary>
        /// <param name="charge">The charge to be persisted.</param>
        /// <returns>A <see cref="ChargeStorageStatus"/> to indicate if the operation was performed successfully.</returns>
        Task<ChargeStorageStatus> StoreChargeAsync(ChangeOfChargesMessage charge);
    }
}
